...
import it.polito.tdp.seriea.model.Stat;
...
public class SerieAController {
    ...
    void handleCarica(ActionEvent event) {
    	...
    	for(Stat stemp:model.getClassificaForSeason(s)){
    		txtResult.appendText(stemp.getTeam().toString()+ " "+stemp.getPunteggio()+"\n");
    	}
	...
	public void setModel(Model model) {
		this.model=model;
		this.boxSeason.getItems().addAll(model.getAllSeason());
